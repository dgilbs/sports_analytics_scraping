...
round((sum(passes_received) * 1.0/sum(minutes)) * 90.0,3) as passes_received_per_90,
round((sum(progressive_passes_received) * 1.0/sum(minutes)) * 90.0,3) as progressive_passes_received_per_90,
