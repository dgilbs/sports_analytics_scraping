  ...
  create view "neondb"."fotmob"."draft_consistency__dbt_tmp"
...
with match_pts as (
    ...
    from "neondb"."fotmob"."fantasy_match_points" p
    left join "neondb"."fotmob"."dim_matches" m on p.match_id = m.match_id
