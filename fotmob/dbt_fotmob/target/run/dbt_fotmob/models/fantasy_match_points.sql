  ...
  create view "neondb"."fotmob"."fantasy_match_points__dbt_tmp"
...
fbref_misc as (
    ...
    join "neondb"."fotmob"."fbref_fotmob_crossref" xref
...
team_conceded as (
    ...
    from team_scored ts
    left join "neondb"."fotmob"."dim_matches" m on ts.match_id = m.match_id
