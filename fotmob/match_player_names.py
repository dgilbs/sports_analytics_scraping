#!/usr/bin/env python3
"""
Fuzzy-match player names in the draft seed file to player_ids in dim_players.

Outputs fotmob/dbt_fotmob/seeds/player_id_mapping.csv with columns:
  seed_name    -- name from the draft seed file
...
The mapping can then be joined in dbt models to link draft data to stats.
...
def main():
    ...
    with open(SEED_PATH, newline="", encoding="utf-8") as f:
        seed_names = [row["name"] for row in csv.DictReader(f)]
